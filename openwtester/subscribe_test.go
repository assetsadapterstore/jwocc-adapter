...
func TestSubscribeAddress_JWOCC(t *testing.T) {

	var (
		endRunning = make(chan bool, 1)
		symbol     = "JWOCC"
		addrs      = map[string]string{
			"JWOCCNeNChKsisFf5tdG1B8YGEiwJ3eCDLSYspE": "sender",
			"JWOCCNimkTECtC5vu9cwFPBxAziSSSz7BnfrfAz": "receiver",
		}
	)
	...
	scanner.SetRescanBlockHeight(141355)
